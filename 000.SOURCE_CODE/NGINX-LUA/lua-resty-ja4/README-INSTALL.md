...
: 后端日志
```txt
2026-06-16 07:59:17  INFO CYBER_CLOAK::web_api::handlers::ja4_fingerprint_handler: [f4cdad3e-cb07-4066-927c-370316778b66] [Ja4FingerprintHandler] X-JA4-Fingerprint: Some("t13d1614h2_86a278354501_e452d144df5e")
```